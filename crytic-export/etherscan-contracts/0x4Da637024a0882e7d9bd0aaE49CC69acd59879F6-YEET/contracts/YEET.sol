...
contract YEET is ERC20, Ownable {
    ...
    constructor() ERC20("Yield Efficient Ethereum Transformer", "YEET") {
        uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
        
        
        mWallet = address(0x89f871c99C682FaB82a5d8052091d7A567C310F5);
        dWallet = address(0x6E5C0B5B989e78E954E1EeB32C60DC9e209fb94F);
