/**
NoUtility
Web: https://noutil.com/

Amidst a backdrop of utility tokens clamoring for attention, NO UTILITY found its niche by boldly proclaiming its absolute lack of function and utility.
Existence is the only feature, and transparency in utility, or the lack thereof, is worn as a badge of honor.

TG: https://t.me/noutilitycoin
X: https://x.com/noutility_erc
*/
...
contract NoUtility is Ownable, ERC20 {
    ...
    string constant _name = "NoUtility";
