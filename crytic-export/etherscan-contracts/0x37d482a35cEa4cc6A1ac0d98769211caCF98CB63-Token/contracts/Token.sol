...
/**
 Neural Speculator $nsTAO
 https://nsTAO.trading
 https://t.me/nstao_trading
 https://t.me/NeuralSpeculatorBot
 https://t.me/reports_nstao
*/
...
contract Token is IERC20Metadata, Ownable {
    //Constants
    string private constant _name = "Neural Speculator";
    string private constant _symbol = "nsTAO";
    ...
    //Maxes
    uint256 public max_tx = 8_000_000 * 10 ** _decimals; //0.8%
    uint256 public max_wallet = 8_000_000 * 10 ** _decimals; //0.8%
    uint256 public swap_at_amount = 3_000_000 * 10 ** _decimals; //0.3%
    ...
    function SetTaxes(uint32 _fee_buy, uint32 _fee_sell) public onlyOwner {
        require(_fee_buy <= max_fee && _fee_sell <= max_fee, "Too high fee");
        fee_buy = _fee_buy;
        fee_sell = _fee_sell;
    }

    function SetLimitTxWallet(uint256 _max_tx, uint256 _max_wallet) public onlyOwner {
        require(
