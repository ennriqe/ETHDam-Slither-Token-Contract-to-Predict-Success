...
contract VTAI is Context, Ownable, IERC20 {
    ...
    uint256 constant public swapThreshold = _totalSupply / 200;
    ...
    string constant private _name = "VoTech AI";
    string constant private _symbol = "VTAI";
