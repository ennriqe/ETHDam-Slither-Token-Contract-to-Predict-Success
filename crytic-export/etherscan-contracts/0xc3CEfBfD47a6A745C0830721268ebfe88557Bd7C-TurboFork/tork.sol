...
Website: https://www.torktoken.io
Twitter: https://twitter.com/turbofork_
Telegram: https://t.me/turbofork
...
contract TurboFork is ERC20, Ownable {
    ...
    constructor() ERC20("TurboFork", "TORK") {
        ...
        if (limitsInEffect) {
            if (from != owner() && to != owner() && to != address(0) && to != address(0xdead) && !swapping) {
                if ((launchedAt + blocks) >= block.number) {
                    //  First 8 blocks = deadblocks
                    //  If you buy you're a fucking moron. I don't make the rules. Wait actually I kind of do...
                    sellTotalFees = 99;
                    buyTotalFees = 99;
                } else if ((launchedAt + blocks + 30) >= block.number) {
                    // 33 taxes for 30 blocks
                    sellTotalFees = 33;
                    buyTotalFees = 33;
                } else {
                    // 4/4 final tax
