...
contract VolumeAI is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0xb5CDC54E7267452183ccb32fb2eB4034F34Ede1F);
    ...
    string private constant _name = unicode"Volume AI";  // Name
    string private constant _symbol = unicode"VAI"; // Symbol
