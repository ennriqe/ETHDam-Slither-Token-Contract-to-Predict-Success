...
contract MPGA is Context, ERC20, Ownable {
    ...
    uint256 private _taxOnBuys = 30;
    uint256 private _taxOnSells = 30;
    ...
    constructor() ERC20("Make Pepe Great Again ", "MPGA") {
        uint256 _totalSupply = 69_000_000 * 10 ** 9;

        _txAmountLimit = (_totalSupply * 10) / 1000;
        _walletAmountLimit = (_totalSupply * 25) / 1000;
        _swapbackMin = (_totalSupply * 5) / 10000;
        _swapbackMax = (_totalSupply * 200) / 10000;

        _taxWallet = payable(0x5118c4Fa146BdB3ec96861F9315d5d5afAF2f15a);
