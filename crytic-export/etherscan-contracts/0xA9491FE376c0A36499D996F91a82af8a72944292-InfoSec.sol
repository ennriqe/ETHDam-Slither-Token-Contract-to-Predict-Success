...
Website: http://infosecerc.com/
Telegram: https://t.me/infosecerc
X: https://x.com/infoseceth
...
contract InfoSec is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x22683B11A367ddb5045f5d7A3b2704D62cD16Dc1);
    ...
    string private constant _name = unicode"InfoSec";  // Name
    string private constant _symbol = unicode"INFOSEC"; // Symbol
