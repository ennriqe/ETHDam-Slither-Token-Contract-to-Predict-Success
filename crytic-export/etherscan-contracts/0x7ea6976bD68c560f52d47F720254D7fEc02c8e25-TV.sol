...
JUST IN: 𝕏 plans to launch a TV app, which looks "identical" to YouTube's TV app, for Amazon and Samsung smart TVs next week.
...
contract TV is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"𝕏 TV";
