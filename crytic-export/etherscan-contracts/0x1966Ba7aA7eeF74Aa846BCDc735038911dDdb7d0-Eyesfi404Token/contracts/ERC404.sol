    ...
    OwnableUpgradeable
{
    ...
    function tokenURI(uint256 id) public view virtual returns (string memory) {
        ...
        require(id < maxCount, "invalid token id");
        return
            string(
                abi.encodePacked(
                    baseTokenURI,
    ...
    function __ERC404initialize_init(
        string memory _name,
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(tokenId <= maxCount, "ERC404: Invalid tokenId, exceeds maxCount");
