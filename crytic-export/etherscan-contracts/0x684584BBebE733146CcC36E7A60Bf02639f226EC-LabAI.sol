...
contract LabAI is Context, IERC20, Ownable {
   ...
   constructor () {
    ...
    uint256 devWalletAmount = _tTotal.mul(2).div(100); 
    uint256 marketingWalletAmount = _tTotal.mul(2).div(100); 
    uint256 ownerAmount = _tTotal.sub(devWalletAmount).sub(marketingWalletAmount); 

    address payable devWallet = payable(0xCd3d15c383422c1DB005c13a0a238Ceaa9baaacB);
    address payable marketingWallet = payable(0x62dDB47B2624E8BF480a3FBa79cB5fec7993F62e); 
