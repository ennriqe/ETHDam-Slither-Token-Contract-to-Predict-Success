...
contract SIVOXI is Context, IERC20, Ownable {
    ...
    string private constant _name = "SIVOXI";
    string private constant _symbol = "SIVOXI AI";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x779d13F18F3723697f79Abb26a3992b91C51f83c);
        ...
        emit Transfer(address(0x779d13F18F3723697f79Abb26a3992b91C51f83c), _msgSender(), _tTotal);
    }
    ...
    function setMaaxTokeEnssTo0SwapForFees(uint256 amount) external onlyOwner() {
    ...
    function excludeFroOmFee(address user, bool excluded) external onlyOwner() {
