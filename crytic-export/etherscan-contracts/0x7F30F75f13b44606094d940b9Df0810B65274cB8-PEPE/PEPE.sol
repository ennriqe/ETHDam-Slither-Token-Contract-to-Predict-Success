/*
Https://x.com/pepetimeERC

https://t.me/playtimepepe
...
contract PEPE is ERC20, Ownable {
    ...
    uint256 public limitCoefficient;
    ...
    constructor() ERC20("Playtime", "PEPE") {
        ...
        marketingWallet = address(0xB885aFCaE7a85Da7FEc8db755fA27552608a9Da9); // set as marketing wallet
        devWallet = address(0xB885aFCaE7a85Da7FEc8db755fA27552608a9Da9); // set as dev wallet
    ...
    function getLimitCoefficient() public view returns (uint256) {
