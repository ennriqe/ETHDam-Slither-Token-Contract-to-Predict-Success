...
/*
    Web:        https://magicgpt.live
    App:        https://store.magicgpt.live
    Doc:        https://docs.magicgpt.live

    Twitter:    https://twitter.com/magicgpt_
    Telegram:   https://t.me/magicgpt_portal
*/
...
contract MagicGpt is Context, IERC20, Ownable {
    ...
    address payable private _feeMagicWallet;
    ...
    constructor (address magicWallet) {
        _feeMagicWallet = payable(magicWallet);
        _balances[_msgSender()] = _totalSupply;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeMagicWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _feeMagicWallet.transfer(amount);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && from != address(this)) {            
            ...
            if(to == uniswapV2Pair && from!= address(this)) {
                if(from == address(_feeMagicWallet)) {
