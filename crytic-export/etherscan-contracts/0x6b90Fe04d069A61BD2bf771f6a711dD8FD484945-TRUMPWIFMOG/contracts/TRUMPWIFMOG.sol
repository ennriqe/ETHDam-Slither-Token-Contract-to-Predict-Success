...
//
//
// Telegram: https://T.me/trumpwifmog
//
//
contract TRUMPWIFMOG is IERC20 , Context, Ownable {
    ...
    string private constant _name = unicode"Trump Wif Mog";
    ...
    constructor() Ownable(_msgSender()) {
        ...
        _balances[address(this)] = 44650000 * 10 ** _decimals;
        _balances[_devWallet] = 2350000 * 10 ** _decimals;
    ...
    function removeLimits() external onlyOwner {
        ...
        _finalBuyTax = 0;
        _finalSellTax = 0;
        emit WalletLimitsRevised(_tTotal);
    }

    function reduceTax() public onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 0;
        emit  TaxLimitsRevised(0);
    }
