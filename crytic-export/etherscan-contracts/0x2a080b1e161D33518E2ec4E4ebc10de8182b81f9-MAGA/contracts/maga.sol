/*
Introducing Make Autism Great Again ($MAGA), the newest memecoin on the Ethereum 
blockchain designed for the baddest, autistic, degenerate mofos in the game.

https://makeautismgreatagain.com/
...
contract MAGA is ERC20, Ownable {
    ...
    constructor() ERC20("Make Autism Great Again", "MAGA") {
        ...
        maxTransactionAmount = (totalSupply * 11) / 1000; // 1.1% max tx
        ...
        marketingWallet = address(0xDee0E13B27F256CDf39bf76fCB0814002F2141Ef); // set as marketing wallet
        devWallet = address(0xDee0E13B27F256CDf39bf76fCB0814002F2141Ef); // set as dev wallet
