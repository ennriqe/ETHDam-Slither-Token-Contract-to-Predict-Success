...
contract FomosToken is ERC20, Ownable {
    ...
    constructor() ERC20("nofomo", "nofomo") Ownable(msg.sender) {
    ...
    function totalSupply() public view override returns (uint256) {
        return currentDistributionTotalSupply + currentLiquidityPoolTotalSupply;
    }
