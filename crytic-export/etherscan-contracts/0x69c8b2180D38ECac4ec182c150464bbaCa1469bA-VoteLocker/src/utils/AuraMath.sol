...
library AuraMath {
    ...
    function to208(uint256 a) internal pure returns (uint208 c) {
        require(a <= type(uint208).max, "AuraMath: uint224 Overflow");
        c = uint208(a);
    }
    ...
    function to48(uint256 a) internal pure returns (uint48 c) {
        require(a <= type(uint48).max, "AuraMath: uint32 Overflow");
        c = uint48(a);
    }
...
/// @notice A library for performing overflow-/underflow-safe addition and subtraction on uint208.
library AuraMath208 {
    function add(uint208 a, uint208 b) internal pure returns (uint208 c) {
        c = a + b;
    }

    function sub(uint208 a, uint208 b) internal pure returns (uint208 c) {
        c = a - b;
    }
}
