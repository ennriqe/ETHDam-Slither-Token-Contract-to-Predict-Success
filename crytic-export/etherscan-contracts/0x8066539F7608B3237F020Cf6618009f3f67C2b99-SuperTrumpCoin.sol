...
contract SuperTrumpCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Super Trump Coin";
    string private constant _symbol = "SUPERTRUMP";
    ...
    uint256 private constant _tTotal = 2600000000 * 10**9;
    ...
    uint256 public _maxTxAmount = 52000000 * 10**9; 
    uint256 public _maxWalletSize = 52000000 * 10**9; 
    uint256 public _swapTokensAtAmount = 52000 * 10**9;
    ...
    constructor() {
        ...
        _marketingAddress = payable(0xae23f60735DD61bbc8d1Bd8F42a9FDC41F40F29A);
