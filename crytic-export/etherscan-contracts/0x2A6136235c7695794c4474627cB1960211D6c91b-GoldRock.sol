...
contract GoldRock is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    string private constant NAME = "GoldRock";
    ...
    uint256 private constant TOTAL_SUPPLY = 10**6 * 10**DECIMALS;
    ...
    uint256 public mTA = 1000 * 10**DECIMALS;
    uint256 public sLP = 3;
    uint256 public bLP = 22;
        ...
        Ownable()
    {
        ...
        _gonBalances[_msgSender()] = _totalSupply;
    ...
    function _aTL(address sender, address recipient, uint256 amount) private {
        ...
        if (recipient == pairAddress) { // Selling
            ...
            // Removed lastBuyTime logic
        }
    }

    function setPairAddress(address newPairAddress) external onlyOwner {
        require(newPairAddress != address(0), "cannot be the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        ...
        if (subtractedValue >= oldValue) {
            ...
            _approve(_msgSender(), spender, oldValue - subtractedValue);
        }
        return true;
    }
