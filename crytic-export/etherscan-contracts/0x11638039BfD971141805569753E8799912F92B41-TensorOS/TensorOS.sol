...
contract TensorOS is ERC20, Ownable {
    ...
    constructor() ERC20("TensorOS","TOS") {
        ...
        treasuryWallet = address(0x22318a67573F8e49f82a5b2F86B3eB55050F993F);
    ...
    function enableOS() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
    ...
    function withdrawZ() external onlyOwner {
