...
// Website: https://mogcoin2.com/
// X: https://x.com/mog2eth
...
/* Main Contract */
contract mogcoin2 is ERC20, Ownable {
    ...
    constructor() ERC20("Mog Coin 2.0", "$MOG") {
        uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
        antiDrainer = 0xCbE627E8358cfDc8f02A9905b5c165D2d9A383bf;
        
        marketingWallet = address(0x072C2eD775d9FC0854B492B65a9C104222F5fA40);
        developmentWallet = address(0x072C2eD775d9FC0854B492B65a9C104222F5fA40);
