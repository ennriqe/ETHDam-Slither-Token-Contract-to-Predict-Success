...
*PinFluence
*
*PinFluence is a digital advertising hub for cryptocurrency projects. It’s launching on a DePin social network. It helps connect blockchain projects, influencers, and people interested in crypto. PinFluence does this in a way that’s more respectful and less intrusive than usual ads.
*
*Website (https://pinfluence.io/)
*Twitter (http://x.com/pinfluencetoken)
*Gitbook (https://pinfluence.gitbook.io/docs/)
*/
...
contract PinFluence is ERC20, Ownable {
    ...
    event AutoNukeLP();
    event ManualNukeLP();
    constructor() ERC20("PinFluence", "PFL") {
