...
NitroFi is a cutting-edge Layer 2 blockchain solution designed to improve the scalability and efficiency of existing blockchain networks with advanced technology. 
NitroFi aims to address the challenges of slow transaction speeds and high fees, making blockchain technology more accessible and user-friendly. 
By solving the key aspects of providing a comprehensive Layer 2 solution, NitroFi aims to not only surpass current Layer 2 alternatives, 
but also drive the adoption of blockchain technology in general. Join us to shape the future of decentralized transactions with NitroFi!

Telegram:   https://t.me/Nitro_Fi
Twitter:    https://twitter.com/Nitro_Fi
Whitepaper: https://nitrofi.gitbook.io/nitrofi-whitepaper/
Website:    http://nitrofi.digital
...
contract NITO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NitroFi Tools", "NITO") {
        ...
        operationWallet = address(0x21b3f1de3CF4a559ec1AeFbf780f0250c337807a); // set as operation wallet
    	devWallet = address(0xAdC82C4F160E9FB2aF2dDAF6ddD9c726c9E67c45); // set as dev wallet
