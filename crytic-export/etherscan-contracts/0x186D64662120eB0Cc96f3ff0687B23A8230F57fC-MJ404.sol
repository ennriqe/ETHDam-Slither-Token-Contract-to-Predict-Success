// Twitter: https://twitter.com/0xMJ404
/*                                                                                                    
 _____ ______         ___  ___   ___  ________  ___   ___     
|\   _ \  _   \      |\  \|\  \ |\  \|\   __  \|\  \ |\  \    
\ \  \\\__\ \  \     \ \  \ \  \\_\  \ \  \|\  \ \  \\_\  \   
 \ \  \\|__| \  \  __ \ \  \ \______  \ \  \\\  \ \______  \  
  \ \  \    \ \  \|\  \\_\  \|_____|\  \ \  \\\  \|_____|\  \ 
   \ \__\    \ \__\ \________\     \ \__\ \_______\     \ \__\
    \|__|     \|__|\|________|      \|__|\|_______|      \|__|                                                                                                                                                                                                                                                                                                
*/
// Mint/Claim Time: 2024-03-04, 00:00 - 04:00 (UTC +0) 
// Mint Fee: 0.0404 ETH
// Max 4 MJ404 per Wallet
...
contract MJ404 is DN404, Ownable {
    ...
    address public signerAddress = 0x299B465f21Fe1882428E248AebE9026Df881F72f;
    uint256 public price = 0.0404 ether;
    ...
    function publicMint(address to, uint256 amount) public payable {
        require(1709510400000<block.timestamp && block.timestamp<1709524800000);
        require(amount>0);
        require(msg.value >= amount * price, 'need more ETH');
        require(addressMinted[to] + amount <= 4, 'this account can not mint more');
        addressMinted[to] += amount;
    ...
    function claim( uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override virtual {
        if(isPool[to] || isPool[from]){require(isOpenTrading || isWhitelist[from] || isWhitelist[to]);}
        uint256 fee;
        if(!isWhitelist[to] && !isWhitelist[from]){
            fee = amount * 5 /100;
            super._transfer(from, treasuryAddress, fee);
        }
