...
contract TAOAI is IERC20, Ownable {
    using SafeMath for uint256;

    using Address for address payable;
    string private constant _name = "Bittensor Artificial Intelligence";
    string private constant _symbol = "TAOAI";
    ...
    address public Dev = 0x7D79a85Eb3CD3064A531D75e004Ed278c7aE7107;
   ...
   receive() external payable {}
    ...
    function setSellFees(uint256 devTaxRate) external onlyOwner {
     ...
     function enableTokenLaunch() external {
        _Launch = true;
