...
library Address {
     ...
     * use https://solidity.readthedocs.io/en/laNODIFY/units-and-global-variables.html?highlight=abi.decode#abi-encoding-and-decoding-functions[`abi.decode`].
     *
     * Requirements:
     *
...
contract GPUNodes is ERC721Enumerable, Ownable, ControlledAccess{
    using Strings for uint256;
    string baseURI;
    string public baseExtension = ".json";
    uint256 public timeDeployed;
    uint256 public allowMintingAfter = 0;
    address public NODIFY;
    ...
    function updateNODIFYAddress( address _NODIFYAddress) public onlyOwner{
        NODIFY = _NODIFYAddress;
    }
    ...
    function mint(uint _type, uint256 n_tokens) public payable {
        ...
        if (msg.sender != owner()) {
            require(IERC20(NODIFY).transferFrom(msg.sender, address(this), price), "Not enough funds");
            IERC20(NODIFY).transfer(rewardPool, price-_tax);
        }
    ...
    function emergenceyWithdrawTokens() public onlyOwner {
        IERC20(NODIFY).transfer(owner(), IERC20(NODIFY).balanceOf(address(this)));
    }
