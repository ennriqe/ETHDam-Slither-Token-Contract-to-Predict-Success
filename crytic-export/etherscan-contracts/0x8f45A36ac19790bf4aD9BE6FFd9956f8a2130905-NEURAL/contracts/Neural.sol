...
contract NEURAL is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x6Eb49AF8569c452C9FCb572eEe6C6DC5cAD4F6e7);
    ...
    string private constant _name = unicode"Neural AI";  // Name
    string private constant _symbol = unicode"NEURAL"; // Symbol
    uint256 public _taxSwapThreshold= 10000 * 10**_decimals;
    uint256 public maxWalletLimit = 200000 * 10 ** decimals();
