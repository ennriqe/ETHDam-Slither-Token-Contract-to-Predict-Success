...
contract MUCHUL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Muchul Sulur";
    string private constant _symbol = unicode"MUCHUL";
