...
contract Netmind is Context, IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 120 ** 6 * 10 ** decimals();

    string private _name;
    string private _symbol;

    uint256 public buyTax = 2500;  // 1%
    uint256 public sellTax = 2500; // 1%
    uint256 public sendTax = 500;
    uint256 public div = 10000;

    address public marketingWallet = 0xc290A1a94fBC485135B906e211bF8fE8F564eeF4; // marketing wallet
