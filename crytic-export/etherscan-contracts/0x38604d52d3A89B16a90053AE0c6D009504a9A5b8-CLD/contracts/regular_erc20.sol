/**
        Cloud AI - On-Demand AI in the Cloud
        https://usecloudai.com
*/
...
contract CLD is ERC20, Ownable {
    ...
    constructor() ERC20("Cloud AI", "CLD") {
        ...
        maxTransactionAmount = totalSupply * 1 / 100; // 2% Max Transaction
        ...
        marketingWallet = address(0x3511C2B83a1803f9c0cD7367A899A1Da2f62DD4F);
        ...
        _mint(devWallet, totalSupply * 16 / 100);
    ...
    function openCLD() external onlyOwner payable {
