...
Because the SOL coin rugged. Eth is king.
*/
...
contract BARON is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BARON";
    string private constant _symbol = unicode"BARON";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x7B0cd7da285d3c4fBaAdb88796EB78E34D41478B);
