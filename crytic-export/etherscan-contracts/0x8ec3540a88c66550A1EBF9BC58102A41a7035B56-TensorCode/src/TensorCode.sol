// Website: https://tensorcodeai.xyz
// Docs: https://docs.tensorcodeai.xyz
// Twitter: https://x.com/tensorcode_ai
// Telegram: https://t.me/tensor_code
...
contract TensorCode is ERC20, Ownable(msg.sender) {
    ...
    constructor() ERC20("TensorCode AI", "TCAI") {
        ...
        treasuryWallet = address(0x375F5db2e7f22BdE5c601D94Bd4304f02Cd89A2A);
    ...
    function withdrawTCAI() external onlyOwner {
