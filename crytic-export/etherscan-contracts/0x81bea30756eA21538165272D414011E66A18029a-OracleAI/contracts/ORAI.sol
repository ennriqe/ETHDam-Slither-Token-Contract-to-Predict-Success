...
OracleAI - data oracles on the BitTensor network
Get decentralized sources of real-world data on-chain to use in smart contracts.
...
contract OracleAI is IERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "OracleAI";
    ...
    function setDevWallet(address _team) external onlyOwner {
        devWallet = _team;
    }
