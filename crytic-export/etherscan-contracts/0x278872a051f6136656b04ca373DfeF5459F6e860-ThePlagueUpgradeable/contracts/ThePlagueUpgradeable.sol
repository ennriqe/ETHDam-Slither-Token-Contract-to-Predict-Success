...
import "./interfaces/IDelegationRegistryV2.sol";
    ...
    IThePlague
{
    ...
    modifier isDelegate(address vault) {
        bool isDelegateValid = IDelegationRegistryV2(delegationRegistryAddress)
    ...
    IOperatorFilterRegistry constant operatorFilterRegistry =
        IOperatorFilterRegistry(_OPERATOR_FILTER_REGISTRY);
